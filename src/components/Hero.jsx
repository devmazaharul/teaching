...
export default function Hero() {
  return (
    <div className='heroimg w-full mx-auto    shadow-md rounded-md object-contain '>
    
   <div className='bgreduce text-gray-300 flex items-center h-[500px]'>
   <div className='py-10 px-8 w-[50%]'>
   <h1 className='text-5xl font-bold py-3 leading-snug '>Tpgader well explore  new things</h1>
