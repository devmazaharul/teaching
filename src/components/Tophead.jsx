   ...
   <div className="border-b px-4 lg:px-0  text-gray-600 text-sm ">
     <div className="flex items-center justify-between md:w-[85%] mx-auto ">
        <div className="flex items-center gap-2">
            <p className="flex items-center gap-1"><MdOutlineEmail/>expertmazaharul@gmail.com</p>
            <p className="flex items-center gap-1 capitalize"> <MdOutlineLocationOn/> Moon ave, New York, 2020 NY US</p>
        </div>
        <div className=" hidden lg:flex md:block items-center gap-2">
